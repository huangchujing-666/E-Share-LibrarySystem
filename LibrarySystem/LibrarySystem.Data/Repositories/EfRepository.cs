    ...
    public class EfRepository<T> : IRepository<T> where T : class, IAggregateRoot
    {
        ...
        protected virtual IDbSet<T> Entities
        {
            get
            {
               ...
               // return new OrderingSystemDbContext("OrderingSystem").Set<T>();
            }
        }
        ...
        public IQueryable<T> Table
        {
            get
            {
                this._dbContext = new LibrarySystemDbContext("LibrarySystem"); this._entities = null;
        ...
        { 
            this._dbContext = new LibrarySystemDbContext("LibrarySystem");
        ...
        {
            this._dbContext = new LibrarySystemDbContext("LibrarySystem");
            return this._dbContext.ExecuteSqlCommand(sql, true, null, parameters);
        }
    }
}
